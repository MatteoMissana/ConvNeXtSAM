...
from utils.plots import feature_visualization, feature_visualization_meanmaps
...
class BaseModel(nn.Module):
    ...
    def fuse(self):  # fuse model Conv2d() + BatchNorm2d() layers
        ...
        for m in self.model.modules(): #qui forse ho sgravato
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in {
                ...
                ConvNextBlock, DownSample, Stem, SPPFConvNext, ConvNextBlockCSP, C3Next, C3Next1, ConvNxt,
                CSPResNextBlock, SpatialAttDownSample, ChannelAttDownSample, SAMdownYOLO, ConvNextCSP1, ConvNextCSP0,
                ConvNextCSP2, ConvNextCSP3, ConvNextCSP4, ConvNextCSP5, ConvNextCSP6, SAMDropDown, GC3, GBottleneck,
                SEBottleneck, C3SE,  CBL, Residual, Residual_CSP, CSPBlock, nn.Conv2d, CSPFPN, CBAMdown
                }:    #cambia qui
            c1, c2 = ch[f], args[0]
            ...
            if m is CSPResNextBlock:
                args[2] = int(gw * args[2])

            if m in {GC3, GBottleneck}:
                args.insert(2, gw)

            if m in {BottleneckCSP, C3, C3TR, C3Ghost, C3x, ConvNextBlock, ConvNextBlockCSP, C3Next, C3Next1,
                     CSPResNextBlock, ConvNextCSP1, ConvNextCSP0, ConvNextCSP2, ConvNextCSP3, ConvNextCSP4,
                     ConvNextCSP5, ConvNextCSP6, GC3, GBottleneck, C3SE, Residual_CSP, CSPBlock, CSPFPN
                     }:
